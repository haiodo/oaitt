...
| Движки | GigaAM (PyTorch, MLX и ONNX), multilingual, Parakeet, Whisper, WhisperX | GigaAM MLX (CTC и RNNT), Parakeet TDT v3 |
...
- **Десять ASR движков**: GigaAM Native, GigaAM MLX, GigaAM Swift (CTC и RNNT), GigaAM Multilingual MLX (Apple Silicon), Parakeet TDT v3 (25 языков, word timestamps), onnx-asr (ONNX Runtime, CPU - amd64 и arm64), GigaAM via HF, Hugging Face Transformers и WhisperX
